...
namespace ifb::memory {
    ...
    void reservation_assert_valid (const mem_reservation_t* reservation);
};
...
#define ifb_memory_macro_stack_push_arena(stack)             (mem_arena_t*)ifb::memory::stack_push_bytes_absolute_pointer (stack, IFB_MEMORY_STRUCT_SIZE_ARENA)
#define ifb_memory_macro_stack_push_reservation(stack) (mem_reservation_t*)ifb::memory::stack_push_bytes_absolute_pointer (stack, IFB_MEMORY_STRUCT_SIZE_RESERVATION)
