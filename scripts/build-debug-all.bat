...
@set cl_sld_include= /Isld\external /Isld\include /Isld\src /Isld\src\core /Isld\src\math /Isld\src\memory /Isld\src\os /Isld\src\string /Isld\src\win32 /Isld\vcpkg_installed\x64-windows\include
...
@set cl_eng_include= /Iengine\include /Iengine\internal /Iengine\src /Iengine\src\core /Iengine\src\file /Iengine\src\memory /Iengine\src\asset /Isld\include /Isld\vcpkg_installed\x64-windows\include
@set cl_eng_flags=   /nologo /c /MD /LD /Z7 /EHs- /std:c++17 /Od /D_HAS_EXCEPTIONS=0

@set link_eng_in=    ItFliesBy.Engine.obj user32.lib kernel32.lib SLD.Win32.lib Gdi32.lib imgui.lib opengl32.lib
