...
namespace ifb_engine {
    ...
    ifb_global funcptr_ifb_engine_platform_window_opengl_context_create  platform_window_opengl_context_create;
    ifb_global funcptr_ifb_engine_platform_window_imgui_context_create   platform_window_imgui_context_create;
    ...
    platform_api_validate(
        ...
        ifb_engine::platform_window_opengl_context_create  = platform_api_ref.window.opengl_context_create;
        ifb_engine::platform_window_imgui_context_create   = platform_api_ref.window.imgui_context_create;
