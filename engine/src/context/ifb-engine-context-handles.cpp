...
inline IFBUserInput*
ifb_engine::context_handles_get_user_input(
    ifb_void) {
...
ifb_engine::context_handles_get_memory(
    ifb_void) {
...
ifb_engine::context_handles_get_tag_manager(
    ifb_void) {
...
ifb_engine::context_handles_get_arena_manager(
    ifb_void) {
...
ifb_engine::context_handles_get_config(
    ifb_void) {
